...
class Gitlab(Enum):
    ...
    URL = "http://gitlab-service.gitlab.svc"
    KIND = {
        'spring': 2,
    }
...
class XMLPath(Enum):
    # FOLDER = '/Users/parkchangheon/my/git/devops/backend/apps/main/resource/folder_template.xml'
    # JOB = '/Users/parkchangheon/my/git/devops/backend/apps/main/resource/job_template.xml'

    FOLDER = '/root/backend/apps/main/resource/folder_template.xml'
    JOB = '/root/backend/apps/main/resource/job_template.xml'


class Argocd(Enum):
    # URL = "http://34.168.30.192:30133"
    # APP = '/Users/parkchangheon/my/git/devops/backend/apps/main/resource/app.json'
    ...
    APP = '/root/backend/apps/main/resource/app.json'
